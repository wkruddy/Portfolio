    ...
    return (
        <div className="space-y-4">
            ...
            <p className="max-w-xl leading-7 text-muted-foreground">
                I’m interested in thoughtful staff-level IC roles, interesting systems problems,
                and opportunities to create leverage through better tools and better software.
                East Coast–based, remote-first.
            </p>
